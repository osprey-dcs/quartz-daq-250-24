...
Osprey Quartz is a highly scalable 24-bit 250KHz data acquisition system
...
| Depth | 400 mm |
| Weight | ???? |
| Communication | RJ45F (Ethernet) |
| Power Input Voltage | 12 VDC to 2 contact DC barrel Jack ??? |
...
| Power Input Voltage[^acdc] | 10V DC | 13 VDC |
| Power Current | | 4A |
| Analog Input abs. voltage[^analogabs] | -12 V | +12 V |
| Analog Input diff. voltage[^analogdiff] | -12 V | +12 V |
